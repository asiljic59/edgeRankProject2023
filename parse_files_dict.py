    ...
    with open(path,"r",encoding="utf-8") as file:
        ...
        for line in lines:
            ...
            for i in range (2,int(num)-1):
                friends.append(elements[i])
            all_users.update({username:{'username': username,
                                        'number_of_friends':num,
                                        'friends':friends}})
    ...
    with open(path,"r",encoding="utf-8") as file:
        ...
        for index in range(1, len(lines)):
            ...
            content = {
                ...
                "comment_published": datetime.strptime(data[n - 9], "%Y-%m-%d %H:%M:%S"),
    ...
    with open(path,"r",encoding="utf-8") as file:
        ...
        for index in range(1, len(lines)):
            ...
            content = {
                ...
                "status_published": datetime.strptime(data[n - 12], "%Y-%m-%d %H:%M:%S"),
                "author": data[n - 11],
    ...
    with open(path,encoding="utf-8") as file:
        ...
        for line in lines[1:]:
            ...
            content = {
                ...
                "sharer": line_strip[1],
                "status_shared": datetime.strptime(line_strip[2], "%Y-%m-%d %H:%M:%S")
            }
    ...
    with open(path,encoding='utf-8') as file:
        ...
        for line in lines[1:]:
            ...
            content = {
                ...
                "reacted": datetime.strptime(line_strip[3], "%Y-%m-%d %H:%M:%S")
            }
